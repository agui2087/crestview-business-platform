        ...
        <div className="deal-room-grid">
          ...
          <aside className="panel nda-card">
            ...
            {workspace.nda ? <>
              ...
              {!!workspace.nda.signing_layout && ["sent","viewed"].includes(signingState(workspace.nda.status,workspace.ndaControls??null)) && <Link className="button button--primary" href={`/${locale}/dashboard/deals/${id}/sign`}>{locale==='es'?'Revisar y firmar en el PDF':'Review and sign on the PDF'}</Link>}
