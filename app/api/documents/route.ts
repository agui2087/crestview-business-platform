...
import { allowedDocumentTypes, documentCategories, getDocumentStorage, insertDocument, listVault, maxDocumentBytes, ownerFolder, recordActivity, safeName, validCategory } from "@/lib/document-vault";
