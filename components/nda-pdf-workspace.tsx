...
export function NdaPdfWorkspace({mode,locale,source,recordId,version,layout,title,role='buyer',previous={},previousAppearances={},presets=[]}:{mode:'prepare'|'sign';locale:string;source:string;recordId:string;version:number;layout:NdaLayout|null;title:string;role?:SignerRole;previous?:Record<string,string>;previousAppearances?:Partial<Record<SignerRole,SignatureAppearance>>;presets?:{id:string;name:string;layout:NdaLayout}[]}) {
