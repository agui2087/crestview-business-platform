...
|10|Respectful follow-up|Broker declines now require a shared explanation visible above the conversation; stage, explanation and history save atomically. Stale/unauthorized changes and skipped signing rejected; connected decline/reopen passed without granting document access. Pause and future-contact preferences remain.|
