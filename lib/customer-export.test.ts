...
test('task exports neutralize formulas, preserve quotes and label Spanish columns',()=>{
 const csv=tasksCsv([{title:'=HYPERLINK("https://example.invalid")',opportunity_key:'own-deal',due_date:null,priority:'high',status:'pending'}],true);
