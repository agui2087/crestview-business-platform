export type SigningControls = {received_at?:string|null;expires_at?:string|null;withdrawn_at?:string|null;withdrawal_reason?:string|null;last_reminded_at?:string|null;declined_at?:string|null;decline_reason?:string|null};
